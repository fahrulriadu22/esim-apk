...
///
/// In a real implementation this would call the `/api/esims` endpoint.
/// For now it returns hard‑coded dummy data matching the backend schema.
final esimsProvider = FutureProvider<List<ESIM>>((ref) async {
